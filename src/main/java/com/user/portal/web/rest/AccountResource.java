...
import com.user.portal.service.InvalidPasswordException;
import com.user.portal.service.MailService;
import com.user.portal.service.UserService;
import com.user.portal.service.UsernameAlreadyUsedException;
import com.user.portal.service.dto.PasswordChangeDTO;
import com.user.portal.service.dto.UserDTO;
import com.user.portal.web.rest.errors.EmailAlreadyUsedException;
import com.user.portal.web.rest.errors.EmailNotFoundException;
import com.user.portal.web.rest.errors.LoginAlreadyUsedException;
import com.user.portal.web.rest.vm.KeyAndPasswordVM;
import com.user.portal.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.user.portal.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
